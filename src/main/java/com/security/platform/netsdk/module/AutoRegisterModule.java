...
import com.security.platform.netsdk.lib.NetSDKLib.LLong;
...
public class AutoRegisterModule {
	...
	public static NetSDKLib.LLong login(String m_strIp, int m_nPort, String m_strUser, String m_strPassword, String deviceIds) {
		...
		NetSDKLib.LLong m_hLoginHandle = LoginModule.netsdk.CLIENT_LoginEx2(m_strIp, m_nPort, m_strUser, m_strPassword,
	 ...
	 * @return
	 */
	public static NetSDKLib.CFG_DVRIP_INFO getDVRIPConfig(LLong m_hLoginHandle) {
	 ...
	 * @return
	 */
	public static boolean setDVRIPConfig(LLong m_hLoginHandle, boolean enable, String address, int nPort, byte[] deviceId, NetSDKLib.CFG_DVRIP_INFO info) {
